    ...
    return (
        <div className={cx('container')}>
            ...
            <div className={cx('main')}>
                <HeaderPageInfo name="Privacy Policy" />
                <div className={cx('content')}>
                    <h2>Welcome to AliThemes’s Privacy Policy</h2>
                    <ol start={1}>
                        <li>Hi there, we’re AliThemes Pty Ltd (ABN 11 119 159 741) of Level 1, 121 King Street Melbourne, 3000, Australia (“AliThemes”) and welcome to our privacy policy which also applies to our Affiliate Companies. This policy sets out how we handle your personal information if you’re an AliThemes user or visitor to our Sites. It applies across AliThemes Elements, AliThemes Market, AliThemes Twenty20, AliThemes Studio, AliThemes Sites, AliThemes Tuts+ and Placeit (the “Sites”).</li>
                    ...
                    <ol start={17}>
                        ...
                        <li>
                            Occasionally, we will use third party advertising companies to serve ads based on prior visits to our Sites. For example, if you visit our Sites, you may later see an add for our products and services when you visit a different Site. Read more about your options in our <a href="/">cookie policy</a>.
                        </li>
                    </ol>
                    <h2>
                    ...
                    <ol>
                        <li>
                            If you have any questions about our privacy practices or the way in which we have been managing your personal information, please contact our privacy champion in writing at PO Box 16122 Collins Street West Victoria 8007 Australia or privacy.champion@AliThemes.com.
                        </li>
                        <li>
